...
function htmljs_Chat_Init( holder )
{
    ...
    var html =  "<div class=\"holder-html-chat\" >"
		  ...
		  + "<input type=\"text\" id=\"WebChatNameID\" class=\"html-chat-js-name\"  placeholder=\"���...\" >"
	          + "<textarea id = \"WebChatTextID\"background-color=\"#f3f3b9\" placeholder = \"��������� ��������� � online ���\" class=\"html-chat-js-input\" ></textarea>"

                  + "<div class=\"html-chat-js-button-holder\">"
                  +    "<input type=\"button\"  onclick=\"web_send_msg();\" value=\"��������� \" >"
                  +    
                  + "</div>"
             +  "</div>";
    $(holder).html(html);
    ...
    CometServer().subscription("#web_chat_pipe", function(p)
    {
        ...
        // �рокрутка списка сообщений в низ
        $("#WebChatFormForm").animate({ scrollTop: $("#WebChatFormForm")[0].scrollHeight}, "slow");
    });
